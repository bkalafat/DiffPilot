 ...
 */
export function validateParameter(value, paramName, options) {
 ...
 * @throws SecurityError if validation fails
 */
export function validateBranchName(value, paramName = 'branch') {
    if (!value || typeof value !== 'string' || !value.trim()) {
        return null;
    }
    // Length check
 ...
 */
export function validateEnumParameter(value, allowedValues, defaultValue) {
    if (!value || typeof value !== 'string' || !value.trim()) {
        return defaultValue;
    }
 ...
 */
export function sanitizeOutput(output, redactPaths = false) {
    if (!output) {
        return output;
    }
 ...
 */
export function validateWorkingDirectory(directory) {
